...
// Result set 6 of dbo.GetCertificateOfOriginByID — the invoice item lines. Joined to result set 5 in the
// materializer by CertificateOfOriginInvoiceDetailId (not returned as its own top-level collection).

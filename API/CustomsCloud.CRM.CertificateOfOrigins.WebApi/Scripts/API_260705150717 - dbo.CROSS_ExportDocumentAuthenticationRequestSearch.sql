-- Source: CRM.usp_CertificateOfOrigins_CROSS_ExportDocumentAuthenticationRequestSearch (legacy copy, untouched)
-- Target: dbo.CROSS_ExportDocumentAuthenticationRequestSearch - microservice-owned copy (db-proc STEP 0/6.5)
...
      DECLARE @InvoiceIDNumFTS NVARCHAR(4000)  = '''' + REPLACE(LTRIM(RTRIM(@InvoiceIDNum)), ',', ' OR ') + ''''
      

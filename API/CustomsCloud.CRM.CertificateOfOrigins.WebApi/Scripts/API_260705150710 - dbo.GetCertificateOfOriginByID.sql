-- Source: CRM.usp_CertificateOfOrigins_GetCertificateOfOriginByID (legacy copy, untouched)
-- Target: dbo.GetCertificateOfOriginByID - microservice-owned copy (db-proc STEP 0/6.5)
...
/****** Object:  StoredProcedure [CRM].[usp_CertificateOfOrigins_GetCertificateOfOriginNumber]    Script Date: 02/07/2026 18:13:47 ******/
SET ANSI_NULLS ON
